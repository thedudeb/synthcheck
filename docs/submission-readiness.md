...
Status: **engineering-ready for maintainer evaluation**. This report does not claim that SynthCheck passes the private benchmark.
...
6. Report the development result precisely: **77.6% balanced accuracy on the project's frozen diagnostic sample at the required 65% displayed threshold; private benchmark not yet evaluated**.
